...
class OrderUpdateView(UpdateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        if self.request.POST:
            order_items = OrderFormSet(self.request.POST, instance=self.object)
            context.update(orderitems=order_items)
        else:
            context.update(orderitems=OrderFormSet(instance=self.object))
        return context
